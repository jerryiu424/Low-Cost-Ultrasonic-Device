...
<body style="color: black; background-color: rgb(229, 229, 229); background-image: url(images/bg.jpg);" alink="#000099" link="#000099" vlink="#a700a7">
	...
	<div class="container">
  		<div class="row">
		<!-- Gets radius and height in that order to POST -->
  		<form action="./cylinderformText.php" method="POST" enctype="multipart/form-data">
  		<label><b>Radius:</b></label>
  		<input type="number" step="any" name="radius" id="radius"/>
